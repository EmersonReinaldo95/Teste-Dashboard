...
default_movimento_str = "FORNECIMENTO A SETORES CONSUMIDORES"
...
elif movimento_options: st.sidebar.warning(f"Tipo de movimento '{default_movimento_str}' não encontrado. Usando '{movimento_options[0]}' como padrão.")
