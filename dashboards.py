...
default_movimento_str = {movimento_options[7]}
...
elif movimento_options: st.sidebar.warning(f"Tipo de movimento '{default_movimento_str}' não encontrado. Usando '{movimento_options[7]}' como padrão.")
